  ...
  return (
    <div className="glass rounded-4xl p-6 animate-fade-up flex flex-col gap-6">
      ...
      {wakaNumber ? (
        ...
        <div className="flex flex-col gap-2 glass rounded-3xl p-4 border border-white/10">
          <p className="text-label text-white/55 text-center leading-relaxed">
            Vous pouvez dès maintenant ajouter vos produits manuellement depuis votre catalogue.
          </p>
        </div>
      )}
