...
export function DashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-navy-deep">
      {/* Header — logo masqué sur desktop, redondant avec la sidebar */}
      <div className="sticky top-0 z-20 glass border-b border-white/6 px-4 py-3 lg:static lg:border-0 lg:px-8 lg:pt-6 lg:pb-0 lg:bg-transparent lg:backdrop-blur-none">
        <div className="flex items-center justify-between max-w-lg mx-auto lg:max-w-none lg:mx-0">
          ...
          <p className="hidden lg:block font-display font-bold text-h2 text-white">
            Bonjour, {firstName} 👋
          </p>
          <Link
      ...
      <div className="page-container py-5 flex flex-col gap-5 lg:max-w-none lg:px-8 lg:grid lg:grid-cols-3 lg:items-start lg:gap-5">
        {/* Colonne principale : revenu */}
        ...
        {/* Colonne secondaire : actions et alertes — empilées sous le revenu
            en mobile, à côté sur desktop */}
        <div className="flex flex-col gap-5">
          ...
          {/* Action dashboard-spécifique : les autres (Commandes, Catalogue) sont
              déjà à 1 tap via la bottom nav / sidebar, pas besoin de les
              redupliquer ici. */}
          <Link
            to="/app/validation"
